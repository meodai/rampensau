...
- `curveMethod` string      → The curve method to use for easing. One of `'lamé'`, `'arc'`, `'pow'`, `'powY'`, or `'powX'`, or a custom `(i, curveAccent) => [x, y]` function (practical for a bezier curve for example).
